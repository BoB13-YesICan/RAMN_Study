...
struct uds_request clear_diagnostic_information = {
    .payload1 = {0x02, 0x14, 0x01}, // clear whole DTC
    .payload2 = {0x02, 0x14, 0x02}, // delete one ID DTC
    .payload3 = {0x02, 0x14, 0x03}, // Delete memory DTC
...
struct uds_request read_dtc_information = {
    .payload1 = {0x02, 0x19, 0x01}, // Sub-Function 0x01: Report DTC by Status Mask
    .payload2 = {0x02, 0x19, 0x02}, // Sub-Function 0x02: Report DTC by Occurrence Counter
    .payload3 = {0x02, 0x19, 0x03}, // Sub-Function 0x03: Report DTC Snapshot Record
    .payload4 = {0x02, 0x19, 0x04}, // Sub-Function 0x04: Report Supported DTCs
    .payload1_len = 3,
    .payload2_len = 3,
    .payload3_len = 3,
    .payload4_len = 3,
...
struct uds_request read_memory_by_address = {
    .payload1 = {0x05, 0x23, 0xFF, 0xFF, 0x00, 0x10}, // Example: Read from Address 0xFFFF0010, Length 16 bytes
    .payload2 = {0x05, 0x23, 0xFF, 0xFF, 0x00, 0x20}, // Example: Read from Address 0xFFFF0020, Length 32 bytes
    .payload3 = {0x05, 0x23, 0xFF, 0xFF, 0x00, 0x30}, // Example: Read from Address 0xFFFF0030, Length 48 bytes
    .payload4 = {0x05, 0x23, 0xFF, 0xFF, 0x00, 0x40}, // Example: Read from Address 0xFFFF0040, Length 64 bytes
    .payload1_len = 6,
    .payload2_len = 6,
    .payload3_len = 6,
    .payload4_len = 6,
...
struct uds_request security_access = {
    .payload1 = {0x02, 0x27, 0x01}, // Sub-Function 0x01: Request Seed
    .payload2 = {0x02, 0x27, 0x02}, // Sub-Function 0x02: Send Key
...
struct uds_request write_data_by_identifier = {
    .payload1 = {0x07, 0x2E, 0xF1, 0x90, 0x00, 0x01, 0x02, 0x03}, // Example Identifier 0xF190: VIN Number, Data
    .payload2 = {0x07, 0x2E, 0xF1, 0x92, 0x04, 0x05, 0x06, 0x07}, // Example Identifier 0xF192: Calibration ID, Data
    .payload3 = {0x07, 0x2E, 0xF1, 0x93, 0x08, 0x09, 0x0A, 0x0B}, // Example Identifier 0xF193: Calibration Verification Numbers, Data
    .payload4 = {0x07, 0x2E, 0xF1, 0x94, 0x0C, 0x0D, 0x0E, 0x0F}, // Example Identifier 0xF194: Calibration Software Number, Data
    .payload5 = {0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload1_len = 8,
    .payload2_len = 8,
    .payload3_len = 8,
    .payload4_len = 8,
    .payload5_len = 8, // Placeholder
...
struct uds_request routine_control = {
    .payload1 = {0x02, 0x31, 0x01}, // Sub-Function 0x01: Start Routine, Routine ID 0x0000
    .payload2 = {0x02, 0x31, 0x02}, // Sub-Function 0x02: Stop Routine, Routine ID 0x0000
    .payload3 = {0x02, 0x31, 0x03}, // Sub-Function 0x03: Request Routine Results, Routine ID 0x0000
...
struct uds_request request_download = {
    .payload1 = {0x07, 0x34, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00}, // Sub-Function 0x01: Request Download, Addressing Format 1
    .payload2 = {0x07, 0x34, 0x02, 0x10, 0x00, 0x00, 0x00, 0x00}, // Sub-Function 0x02: Request Download, Addressing Format 2
    .payload3 = {0x07, 0x34, 0x03, 0x20, 0x00, 0x00, 0x00, 0x00}, // Sub-Function 0x03: Request Download, Addressing Format 3
...
struct uds_request request_upload = {
    .payload1 = {0x07, 0x35, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00}, // Sub-Function 0x01: Request Upload, Addressing Format 1
    .payload2 = {0x07, 0x35, 0x02, 0x10, 0x00, 0x00, 0x00, 0x00}, // Sub-Function 0x02: Request Upload, Addressing Format 2
    .payload3 = {0x07, 0x35, 0x03, 0x20, 0x00, 0x00, 0x00, 0x00}, // Sub-Function 0x03: Request Upload, Addressing Format 3
    .payload4 = {0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload5 = {0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload1_len = 8,
    .payload2_len = 8,
...
struct uds_request transfer_data = {
    .payload1 = {0x07, 0x36, 0x01, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE}, // Sub-Function 0x01: Transfer Data, Data Block 1
    .payload2 = {0x07, 0x36, 0x02, 0x11, 0x22, 0x33, 0x44, 0x55}, // Sub-Function 0x02: Transfer Data, Data Block 2
    .payload3 = {0x07, 0x36, 0x03, 0x66, 0x77, 0x88, 0x99, 0x00}, // Sub-Function 0x03: Transfer Data, Data Block 3
    .payload4 = {0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload5 = {0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload1_len = 8,
    .payload2_len = 8,
...
struct uds_request request_transfer_exit = {
    .payload1 = {0x02, 0x37, 0x01}, // Sub-Function 0x01: Request Transfer Exit - Cancel Transfer
    .payload2 = {0x02, 0x37, 0x02}, // Sub-Function 0x02: Request Transfer Exit - Complete Transfer
    .payload3 = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload4 = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload5 = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload1_len = 3,
...
struct uds_request write_memory_by_address_3D = { // 변수명 수정됨
    .payload1 = {0x07, 0x3D, 0x01, 0xFF, 0xFF, 0x00, 0x10, 0x00}, // Sub-Function 0x01: Write Memory, Address 0xFFFF0010, Data Length 16 bytes
    .payload2 = {0x07, 0x3D, 0x02, 0xFF, 0xFF, 0x00, 0x20, 0x00}, // Sub-Function 0x02: Write Memory, Address 0xFFFF0020, Data Length 32 bytes
    .payload3 = {0x07, 0x3D, 0x03, 0xFF, 0xFF, 0x00, 0x30, 0x00}, // Sub-Function 0x03: Write Memory, Address 0xFFFF0030, Data Length 48 bytes
    .payload4 = {0x07, 0x3D, 0x04, 0xFF, 0xFF, 0x00, 0x40, 0x00}, // Sub-Function 0x04: Write Memory, Address 0xFFFF0040, Data Length 64 bytes
    .payload5 = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload1_len = 8,
    .payload2_len = 8,
    .payload3_len = 8,
...
struct uds_request tester_present = {
    .payload1 = {0x02, 0x3E, 0x01}, // Sub-Function 0x01: Tester Present - Request Idle State
    .payload2 = {0x02, 0x3E, 0x02}, // Sub-Function 0x02: Tester Present - Request Sleep State
    .payload3 = {0x02, 0x3E, 0x03}, // Sub-Function 0x03: Tester Present - Request Active State
    .payload4 = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload5 = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // Placeholder
    .payload1_len = 3,
    .payload2_len = 3,
